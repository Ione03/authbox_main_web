                        ...
                        <div class="w-full px-4">
                            <div class="mx-auto max-w-[800px] text-center">
                                <h1 class="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                                    Website: Klik, Edit, Selesai!
                                </h1>
                                <p class="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                                    Lihat sesuatu yang ingin diubah?
                                    Klik aja. <br />Ganti logo dengan gambar baru,
                                    ubah nama website, ubah tulisan di landing page, tambah artikel baru
                                    — semuanya langsung di halaman website Anda.
                                    Tidak perlu cari di dashboard,
                                    tidak perlu menu yang ribet.
                                </p>
                                <div class="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                                    <button
                                        onClick$={scrollToAbout}
                                        class="rounded-md bg-primary px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80 cursor-pointer"
                                    >
                                        Lebih Lanjut 💡
                                    </button>
                                </div>
