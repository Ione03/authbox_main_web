        ...
        <section class="relative min-h-screen bg-gray-50 dark:bg-dark">
            ...
            <div class="flex">
                ...
                <aside class={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-stroke bg-white transition-transform duration-300 dark:border-dark-3 dark:bg-dark-2 lg:static lg:z-auto lg:translate-x-0 ${sidebarOpen.value ? 'translate-x-0' : '-translate-x-full'}`}>
                    ...
                    {/* Sidebar Footer */}
                    <div class="mt-auto border-t border-stroke dark:border-dark-3">
                        {/* Upgrade CTA */}
                        <div class="p-4 pb-3">
                            <button
                                onClick$={() => showPricing.value = true}
                                class="flex w-full items-center gap-3 rounded-xl border border-amber-300 bg-gradient-to-r from-amber-50 to-orange-50 p-3 text-left transition hover:shadow-md dark:border-amber-700 dark:from-amber-900/20 dark:to-orange-900/20"
                            >
                                <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-amber-100 dark:bg-amber-900/40">
                                    <svg class="h-4 w-4 text-amber-600 dark:text-amber-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                    </svg>
                                </div>
                                <div>
                                    <p class="text-xs font-bold text-amber-800 dark:text-amber-300">Go Premium</p>
                                    <p class="text-[10px] text-amber-600/80 dark:text-amber-400/70">Custom domains &amp; more</p>
                                </div>
                            </button>
                        </div>

                        {/* User Profile */}
                        <div class="border-t border-stroke px-4 py-3 dark:border-dark-3">
                            <div class="flex items-center gap-3">
                                <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary/10 text-sm font-bold text-primary dark:bg-primary/20">
                                    JD
                                </div>
                                <div class="min-w-0 flex-1">
                                    <p class="truncate text-sm font-medium text-dark dark:text-white">John Doe</p>
                                    <p class="truncate text-[11px] text-body-color dark:text-dark-6">john@example.com</p>
                                </div>
                                <button class="flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-body-color transition hover:bg-gray-100 dark:text-dark-6 dark:hover:bg-dark-3">
                ...
                <main class="flex-1 lg:min-h-screen">
                    ...
                    <div class="flex h-16 items-center justify-between border-b border-stroke bg-white px-6 dark:border-dark-3 dark:bg-dark-2 sm:px-8">
                        <div class="flex items-center gap-4">
                            ...
                            {/* Search */}
                            <div class="hidden items-center gap-2 rounded-lg border border-stroke bg-gray-50 px-3 py-2 transition focus-within:border-primary focus-within:bg-white dark:border-dark-3 dark:bg-dark dark:focus-within:border-primary sm:flex">
                                <svg class="h-4 w-4 text-body-color/50 dark:text-dark-6/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                </svg>
                                <input
                                    type="text"
                                    placeholder="Search sites..."
                                    class="w-40 bg-transparent text-sm text-dark outline-none placeholder:text-body-color/50 dark:text-white dark:placeholder:text-dark-6/50 lg:w-64"
                                />
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
